...
<body class="main_en">
    <div id="app" class="applang">
        ...
        <button class="button">Claim</button>
                        ...
                        <div class="box2">
                            <div class="item">
                                <span>Today Node Power Yield</span>
                                <div>$ {{ $todaysTaskIncome }}</div>
                            </div>
                            <div class="item">
                                <span>Total Node Power Yield</span>
                                <div>$ {{ $totalTaskIncome }}</div>
                            </div>
                            <div class="item">
                                <span>Today Level Yield</span>
                                <div>$ {{ $todaysLevelIncome }}</div>
                            </div>
                            <div class="item">
                                <span>Total Level Yield</span>
                                <div>$ {{ $totalLevelIncome }}</div>
                            </div>
                            <div class="item">
                                <span>Today Direct Yield</span>
                                <div>$ {{ $todaysDirectIncome }}</div>
                            </div>
                            <div class="item">
                                <span>Total Direct Yield</span>
