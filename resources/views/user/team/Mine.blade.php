                        ...
                        <div data-v-3d4e4f5e="" data-v-cfc9a7fc="" class="container">
                            ...
                            <div class="profile-container">
                                ...
                                <img alt="Profile image of a person wearing a hat" class="profile-image"
                                    height="50"
                                    src="{{asset('')}}public/slip/usericon.png"
                                    width="50" />
                                <div class="profile-info" onclick="location.href='{{ route('user.profile') }}'">
                                    ...
                                    ?>
                                        <div class="level">
                                           ...
                                           <?php if($plan==1){echo "Core";}elseif ($plan==4) {echo "Core Prime";}elseif ($plan==20) {echo "Core Plus";}elseif ($plan==40) {echo "Core Max";}elseif ($plan==120) {echo "Core Pro";}elseif ($plan==200) {echo "Core Hub";}elseif ($plan==500) {echo "Core Turbo";}else {echo "Member";}?>
                                        </div>
