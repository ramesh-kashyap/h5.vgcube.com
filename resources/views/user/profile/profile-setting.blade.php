                        ...
                        <ul data-v-636522ac="" data-v-cfc9a7fc="" class="list">
                           ...
                           ?>
                            <li data-v-636522ac="" data-v-cfc9a7fc="" class="flex">
                                ...
                                <div data-v-636522ac="" data-v-cfc9a7fc="" class="flex1 overflow1"></div>
                                <div data-v-636522ac="" data-v-cfc9a7fc="" class="n"> <?php if($plan==1){echo "Core";}elseif ($plan==4) {echo "Core Prime";}elseif ($plan==20) {echo "Core Plus";}elseif ($plan==40) {echo "Core Max";}elseif ($plan==120) {echo "Core Pro";}elseif ($plan==200) {echo "Core Hub";}elseif ($plan==500) {echo "Core Turbo";}else {echo "Member";}?></span></div>
